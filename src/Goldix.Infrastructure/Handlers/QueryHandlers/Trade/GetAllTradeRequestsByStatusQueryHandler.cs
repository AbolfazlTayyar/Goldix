...
public class GetAllTradeRequestsByStatusQueryHandler(ApplicationDbContext db, IMapper mapper) : IRequestHandler<GetAllTradeRequestsByStatusQuery, PagedResult<TradeRequestDto>>
{
