...
public class GetUserRequestsBySearchQueryHandler(ApplicationDbContext db, IMapper mapper) : IRequestHandler<GetTradeRequestsBySearchQuery, PagedResult<TradeRequestDto>>
{
