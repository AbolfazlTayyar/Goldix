        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserRequestId = table.Column<int>(type: "int", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_UserRequests_UserRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_UserRequestId",
                schema: "Wallet",
                table: "WalletTransactions",
                column: "UserRequestId",
                unique: true,
                filter: "[UserRequestId] IS NOT NULL");
