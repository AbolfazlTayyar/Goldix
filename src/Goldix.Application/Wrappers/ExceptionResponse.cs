...
public static class ExceptionResponse
{
    ...
    public static ApiResponse<object> CreateUnhandledErrorResponse(Exception exception, Serilog.ILogger logger, IHostEnvironment environment)
    {
        ...
        {
            logger.Error(exception.InnerException, "Unhandled error with inner exception. Original: {OriginalException}, Inner: {InnerException}",
                exception.GetType().Name, exception.InnerException?.ToString() ?? exception.ToString());
